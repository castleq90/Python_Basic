...
# 람다 함수 -> 할당
lambda_mul_func = lambda x,y:x*y  # 람다는 변수에 할당 가능
print(lambda_mul_func(50,50))

def func_final(x, y, func):
    print('>>>>', x * y * func(100, 100))

func_final(10, 20, lambda_mul_func) # 인자를 2개 받는 함수로 가능 
func_final(10, 20, lambda x,y:x*y) # 람다로 바로 실행하여 동작 가능
